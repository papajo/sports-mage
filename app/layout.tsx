              ...
              <div className="flex justify-between h-16">
                <div className="flex items-center">
                  ...
                  <nav className="ml-10 flex items-center space-x-4">
                    <Link href="/betting" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700">
                      Betting
                    </Link>
                ...
                <div className="flex items-center space-x-4">
                  <Link href="/betting/history" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700">
                    My Bets
                  </Link>
                  <Link href="/betting/wallet" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700">
                    Wallet
                  </Link>
